...
API_KEY = None
_API_KEY = os.environ.get('DEEPSEEK_API_KEY') # preserve value before reading config file
...
if len(ary) > 0:
    ...
    API_KEY = os.environ.get('DEEPSEEK_API_KEY')  # env value is prior to config file
